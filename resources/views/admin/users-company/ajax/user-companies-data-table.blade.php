    ...
    <table class="table table-bordered table-hover dt-responsive nowrap evt_user_data_table_list">
        <thead>
            <tr>
                ...
                <th class="sorting {{ getSortingClassBySortColumn($sortType, 'first_name', $sortColumn) }}" data-column-name="first_name">{{ __('Company Name')}}</th>
                <th class="sorting {{ getSortingClassBySortColumn($sortType, 'last_name', $sortColumn) }}" data-column-name="last_name">{{ __('Commercial Name')}}</th>
            ...
            @if ($users->isNotEmpty())
                @foreach ($users as $user)
                    <tr id="row-{{ $user->slug }}">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark">
                                    ...
                                    <li><a href="{{ route('admin.users.login-as-user', $user->slug) }}"
                                            class="dropdown-item text-white btn btn-sm btn-primary">{{ __('Login As Company') }}</a></li>
                                    @endif
                        ...
                        <td>
                            <span role="button" class="text-white badge text-bg-info evt_download_pdf_btn" data-file-name="{{$user->slug}}" data-href="{{ route('admin.users.ajax-kyc-address', [$user->slug, 'user-account']) }}" data-user-id="{{$user->id}}">{{ __('Download User Company Account')}}</span>
                        </td>
