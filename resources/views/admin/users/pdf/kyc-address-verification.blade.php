				...
				<tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							<tr style="width: 100%;">
								<td>
									<p style="font-weight: 400; border-collapse: collapse; padding: 6px 12px 8px 12px; color: #000000; width: 100%;">CODIGO OTP:<span style="font-weight: 600; margin-left: 5px; color: #000000; width: 100%;">{{$user->address_verify_otp}}</span></p>
								</td>
							</tr>
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070; border-top: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $user->name }}</td>
							</tr>
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $user->address }}</td>
							</tr>
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070;">
							...
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $user->phone_number }}</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td style="padding: 0; border-collapse: collapse; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070; border-top: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $user->registered_at }}</td>
							</tr>
							<tr style="width: 100%; border-collapse: collapse; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">Nro de Documento:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $user->issuer->ruc_text_id }}</td>
							</tr>
						</table>
					</td>
				</tr>
