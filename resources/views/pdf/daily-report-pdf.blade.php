					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070; border-top: 1px solid #707070;">
								...
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">12</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">255</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('Sent Offers') }}</td>
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">58</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('Counteroffers Sent') }}</td>
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">2</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('Online users') }}</td>
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">10</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('Completed Operations') }}</td>
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">4</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">Gs. 255.145.014</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px 4px 35px; text-align: left;">
									<ul>
								...
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">USD 10.544,00</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('Commissions Generated') }}</td>
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">7</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px 4px 35px; text-align: left;">
									<ul>
								...
								<td style="color: #939393; font-weight: 500; padding: 4px 12px; text-align: right;">Gs. 4.500.000</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px 4px 35px; text-align: left;">
									<ul>
