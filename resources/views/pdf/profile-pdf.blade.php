			...
			<table style="width: 100%;">
				<tr>
					<th style="text-align: left;">
						<p style="color: #000000; font-size: 14px; font-weight: 600; text-transform: capitalize;">Biggie S.A.<span style="color: #707070; padding:0 0 0 10px; font-size: 12px; font-weight: 500; text-transform: capitalize;">{!! __('Casa Rica') !!}</span></p>
					</th>
				</tr>
				...
				<tr>
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">RUC:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">4.555.104-5</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Date of Registry') !!}:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">May 31, 2023</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070; border-top: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">0</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Documents Sold') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">4</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">1</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Solved Disputes') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">100</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Average Day Delay in Payment') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">14</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Average Retention') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">18%</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Transactional Average') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">USD 15.450,00, Gs. 6.250.000</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Average Discount') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">2.34%</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Solved Disputes') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">100</td>
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{!! __('SI') !!}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
