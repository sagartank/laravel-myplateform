			...
			<table style="width: 100%;">
				<tr>
					<th style="text-align: left;">
						<p style="color: #000000; font-size: 14px; font-weight: 600; text-transform: capitalize;">Guaranteed Repurchase (MIPO+)<span style="color: #707070; padding:0 0 0 10px; font-size: 12px; font-weight: 500; text-transform: capitalize;">{!! __('Payer') !!}</span></p>
					</th>
				</tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">USD 14.500,00</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
				...
				<tr>
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">CHECK - OP32  Antonio Benitez  EZG S.A.</td>
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">29.500,00 USD</td>
							</tr>
						</table>
					</td>
				</tr>
