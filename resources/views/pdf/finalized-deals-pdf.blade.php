					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">4.53%</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">30.900,00 USD</td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070; border-top: 1px solid #707070; ">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">CHECK - OP25  Antonio Benitez  EZG S.A.</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">14.000,00 USD</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">CHECK - OP32  Antonio Benitez  EZG S.A.</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">15.000,00 USD</td>
