...
<div class="contract_wrapper">
        ...
        @if($is_rate == 'No'  && $val->rate == 'Yes')
            <div class="innerbox">
                <div class="leftpart">
                    ...
                    <p class="text-14-medium">{{ __('Status') }}: <span class="greydisable">{{ __('Pending') }}</span></p>
                </div>
                <div class="rightpart">
                    <div class="signContract_btn">
                        @if(isset($is_data['class']) && $is_data['class'] == 'current' && ($is_rate == 'No' || $operation_detail->offer_status == 'Completed'))
                        <a href="#rating-modal" data-bs-toggle="modal" class="text-14-medium greybtn">{{ __('View Review') }}</a>
                        @else
                        <a href="javascript:;" class="text-14-medium greybtn">{{ __('View Review') }}</a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        @if($is_rate == 'No'  && $val->rate == 'Yes')
            <div class="innerbox">
                ...
                <div class="rightpart">
                    <div class="signContract_btn">
                        @if(isset($is_data['class']) && $is_data['class'] == 'current' && ($is_rate == 'No' || $operation_detail->offer_status == 'Completed'))
                        <a href="#rating-modal" data-bs-toggle="modal" class="text-14-medium">{{ __('View Review') }}</a>
                        @else
                        <a href="javascript:;" class="text-14-medium greybtn">{{ __('View Review') }}</a>
                        @endif
                    </div>
    ...
    {{--     <div class="attach_wrap">
        ...
        <div class="innerbox">
            ...
            <div class="rightpart">
                <div class="signContract_btn">
                    <a href="javascript:;" class="text-14-medium">{{ __('Send Request') }}</a>
                </div>
            </div>
        </div>
