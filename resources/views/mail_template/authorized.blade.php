    ...
    <table style="width: 100%;padding:27px 30px;background: #11295A;">
      <tr>
        ...
        <td style="text-align: end;">
          <a href="javascript:;" class="accountbtn"><i><img src="{{ asset('images/mipo/mail_template/icon/user.png') }}" alt="no-image"></i><span style="display: inline-block;vertical-align:middle;margin:-9px 0 0 0;padding:0 0 0 6px;">Account</span></a>
        </td>
      </tr>
  </table>
  <div class="tabdata">
    <table style="width: 100%;">
        ...
        <tr>
          <table style="width: 100%;">
            ...
            <tr>
              <p style="padding-top: 32px;">Thanks,</p>
        ...
        <tr>
              ...
              <a href="javascript:;" style="color:#0D6EFD;display:flex;text-decoration:none;justify-content:center;padding-top:10px;">www.mipo.com.py</a>
        </tr>
      </table>
   </div>
  </div>
