<div class="advance_filter_btn">
    ...
    <form name="deal_form_filter_dst" id="deal_form_filter_dst" class="deal_form_filter_dst" method="post">
        <div class="filter_modal_wrap">
                ...
                <div class="filter_modal_toprow">
                            ...
                            @if (config('constants.TYPE_OF_DOCUMENT'))
                                @foreach (config('constants.TYPE_OF_DOCUMENT') as $key => $val)
                                    <div class="filter_checkbox_wrap">
                                        ...
                                        <label for="catagory_contracts_{{ $key }}">{{ __($val) }}</label>
                                    </div>
                                @endforeach
                            @endif
                        </div>
                            ...
                            @if (config('constants.CURRENCY_TYPE'))
                                @foreach (config('constants.CURRENCY_TYPE') as $key => $val)
                                    <div class="filter_checkbox_wrap">
                                        ...
                                        <label class="cus_radio" for="preferred_currency{{ $key }}">{{ $val }} </label>
                                    </div>
                                @endforeach
                            @endif
                        </div>
                    ...
                    <div class="filter_modal_topcol filter_modal_topcol_duration">
                        ...
                        <div class="calender_wrap">
                            <input type="text" name="duration_date_range" class="form-control" id="duration_date_range" readonly="" style="height: 36px;">
                            ...
                            <div class="filter_modal_select modal_form_wrp">
                                <div class="modal-wrap">
                                    {{-- <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-6-u5l6" style="width: 100%;"> --}}
                                        ...
                                        <select class="js-example-basic-multiple evt_get_seller" name="seller_ids[]" multiple="multiple" style="width: 250px;">
                                        </select>
                                        {{-- <span class="dropdown-wrapper" aria-hidden="true"></span> --}}
                                    {{-- </span> --}}
                                </div>
                    ...
                    <div class="filter_modal_morerow">
                        <div class="filter_modal_morecol">
                            ...
                            <div class="filter_modal_select modal_form_wrp">
                                <div class="modal-wrap">
                                    <select class="js-example-basic-multiple evt_get_issuer" name="issuer_ids[]" multiple="multiple" style="width: 250px;">
                                    </select>          
                                    {{--  <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-6-u5l6" style="width: 100%;">
                                        <span class="selection">
            ...
            <div class="filter_modal_bottom">
                <div class="filter_modal_bottom_left">
                    <input type="reset" value="{!! __('Reset') !!}" id="btn_reset_advance_filter_modal" data-device-type="dst" class="simpalbtn resetbtn evt_deal_form_filter_reset">
                    <input type="submit" value="{!! __('Apply Filter') !!}" id="btn_advance_filter_modal_form" data-device-type="dst" class="btn btn-primary evt_deal_form_filter_apply">
                </div>
            </div>
        </div>
    </form>
