                                            ...
                                            {{-- nav tab:st --}}
                                                <div class="tab_row">
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        ...
                                                        <li class="nav-item text-14-medium" role="presentation">
                                                            <button class="nav-link active_inactve_tab active" data-currency="Gs." id="gugs-tab" data-bs-toggle="tab" data-bs-target="#gugs" type="button" role="tab" aria-controls="gugs" aria-selected="false">{!! __('Guarani (Gs.)') !!}</button>
                                                        </li>
                                                    </ul>
                                                        <div class="tab-content" id="ajax_group_explore_operation">
                                                            @if(false)
                                                            <div class="tab-pane fade show active" id="amedlr" role="tabpanel" aria-labelledby="amedlr-tab">
