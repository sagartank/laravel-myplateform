    ...
    @endsection
        ...
        <div class="ipv-verification-page">
            ...
            <div class="ipv-block-main">
                ...
                <form action="{{ route('verify.in-person') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="ipv-colum-block">
                        <div class="left-colum">
                            <div class="upload-photo-block">
                                <div class="input-row">
                                    <label class="form-label" for="id_proof_image_front">{{ __('Upload a ID Proof Front') }}</label>
                                    <div class="input-group">
                                        <input class="form-control @error('id_proof_image_front') is-invalid @enderror" type="file" multiple id="id_proof_image_front" name="id_proof_image_front[]" required>
                                    </div>

                                    <div class="placeholder-img" id="placeholder-img-wrap-front" style="display: none">
                                        {{-- <img src="#" id="placeholder-img"> --}}
                                    </div>
                                </div>
                            </div>
                            <div class="upload-photo-block">
                                <div class="input-row">
                                    <label class="form-label" for="id_proof_image_backend">{{ __('Upload a ID Proof Backend') }}</label>
                                    <div class="input-group">
                                        <input class="form-control @error('id_proof_image_backend') is-invalid @enderror" type="file" multiple id="id_proof_image_backend" name="id_proof_image_backend[]" required>
                                    </div>

                                    <div class="placeholder-img" id="placeholder-img-wrap-backend" style="display: none">
                                        {{-- <img src="#" id="placeholder-img"> --}}
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="verification-code">
                                <div class="input-row">
                                    <label class="form-label">{{ __('IPV verification code') }}</label>
                                    <div class="code-img" id="random-code">
                                        {{ $randomCode }}
                                    </div>
                                    <div class="code-links d-flex align-items-center justify-content-between">
                                        <a href="#" onclick="event.preventDefault(); clearInterval(timerInterval); clearInterval(newCodeInterval); generateRandomCode(); initCode();" id="gen_random_btn">
                                            {{ __('Generate new code') }}                                            
                                        </a>
                                        <span class="new-code-timer"></span>
                                    </div>
