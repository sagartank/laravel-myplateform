...
<body>
	<div class="pdf-wrapper">
		...
		<div class="pdf-body">
			<div class="h2">{{ __('Finalized Deals')}}</div>
			<div class="h5">{{ __('Borrower')}}</div>
						...
						<table class="pdf_income_lista_row">
							<tr>
								<td class="pdf_income_lista_col">
									<table class="pdf_income_lista_box">
										<tr>
											<td class="h4">{{ __('Total Sold') }}</td>
										</tr>
										<tr>
											<td class="income_price pdf_color_green">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_sold) }}</td>
										</tr>
									</table>
								</td>
								<td class="pdf_income_lista_col">
									<table class="pdf_income_lista_box">
										<tr>
											<td class="h4">{{ __('Total Sold (Paid)') }}</td>
										</tr>
										<tr>
											<td class="income_price">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_sold_paid) }}</td>
										</tr>
									</table>
								</td>
                                <td class="pdf_income_lista_col">
									<table class="pdf_income_lista_box">
										<tr>
											<td class="h4">{{ __('Total Pending Payment Receipt') }}</td>
										</tr>
										<tr>
											<td class="income_price pdf_color_green">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_pending_payment_receipt) }}</td>
										</tr>
									</table>
								</td>
							...
							<tr>
                                <td class="pdf_income_lista_col">
                                    <table class="pdf_income_lista_box">
                                        <tr>
                                            <td class="h4">{{ __('Total Documents Due') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="income_price pdf_color_waiting">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_documents_due) }}</td>
                                        </tr>
                                    </table>
                                </td>
								<td class="pdf_income_lista_col">
									<table class="pdf_income_lista_box">
										<tr>
											<td class="h4">{{ __('Total Uncashable') }}</td>
										</tr>
										<tr>
											<td class="income_price pdf_color_red">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_uncashable) }}</td>
										</tr>
									</table>
								</td>
								<td class="pdf_income_lista_col">
									<table class="pdf_income_lista_box">
										<tr>
											<td class="h4">{{ __('Total Disputes') }}</td>
										</tr>
										<tr>
											<td class="income_price">{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $total_disputes) }}</td>
										</tr>
									</table>
								</td>
							</tr>
												...
												<table>
													<tr>
														<td class="pdf_income_lista_bottom_blk">
															<table>
																<tr>
																	<td class="pdf_title_block_top h4 pdf_color_green">
																		{{ __('Total Sold (Paid)') }}
																	</td>
																</tr>
																		...
																		<table>
																			<tr>
																				<td style="padding: 0 10px 0 0 !important;">
																					<div class="pdf_chaque_name">{{ $sold_paid->operation_type_number.' - '.$sold_paid->seller->name  }}</div>
																					<div class="pdf_chaque_ownar">{{ $sold_paid->issuer->company_name }}</div>
																				</td>
												...
												<table>
													<tr>
														<td class="pdf_income_lista_bottom_blk">
															<table>
																<tr>
																	<td class="pdf_title_block_top h4 pdf_color_red">
																		{{ __('Total Pending Payment Receipt') }}
																	</td>
																</tr>
																...
																<tr>
																	<td style="padding: 5px 10px;">
																		<table>
																			<tr>
																				<td style="padding: 0 10px 0 0 !important;">
																					<div class="pdf_chaque_name">{{ $pending_payment_receipt->operation_type_number.'-'.$pending_payment_receipt->seller->name  }}</div>
																					<div class="pdf_chaque_ownar">{{ $pending_payment_receipt->issuer->company_name }}</div>
																				</td>
																				<td class="pdf_chaque_amount" style="padding: 0 0 0 10px !important; vertical-align: top;">
																					{{ app('common')->currencyBySymbol($req_param['currency_type']).' '.app('common')->currencyNumberFormat($req_param['currency_type'], $pending_payment_receipt->amount) }}
																				</td>
																			</tr>
																		</table>
																	</td>
																		...
																		<table>
																			<tr>
																				<td class="pdf_total_count_income">
																					<table>
																						<tr>
																							<td style="padding: 0 10px 0 0 !important;" class="pdf_total_count_income_title pdf_color_red">
                                                                                                {{ __('Total') }}
																							</td>
																							<td class="pdf_total_count_income_total pdf_color_red" style="padding: 0 0 0 10px !important;vertical-align: top;">
									...
									<table>
										<tr>
											<td class="pdf_income_lista_bottom_blk">
												<table>
													<tr>
														<td class="pdf_title_block_top h4 pdf_color_waiting">
															{{ __('Total Due') }}
														</td>
													</tr>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 5px 10px;">
                                                                <table>
                                                                    <tr>
                                                                        <td style="padding: 0 10px 0 0 !important;">
                                                                            <div class="pdf_chaque_name">{{ $documents_due->operation_type_number.'-'.$documents_due->seller->name }}</div>
                                                                            <div class="pdf_chaque_ownar">{{ $documents_due->issuer->company_name }}</div>
                                                                        </td>
                                                                        <td class="pdf_chaque_amount" style="padding: 0 0 0 10px !important; vertical-align: top;">
															...
															<table>
																<tr>
																	<td class="pdf_total_count_income">
																		<table>
																			<tr>
																				<td style="padding: 0 10px 0 0 !important;" class="pdf_total_count_income_title pdf_color_waiting">
                                                                                    {{ __('Total') }}
																				</td>
																				<td class="pdf_total_count_income_total pdf_color_waiting" style="padding: 0 0 0 10px !important;vertical-align: top;">
