...
<body>
	<div class="pdf-wrapper">
		...
		<div class="pdf-body">
			<table class="content-table" style="max-width: 90%; margin: 0 auto; " >
				<tr>
					<td>
						...
						<ol style="list-style: decimal; padding: 20px 0 20px 25px;">
							...
							<li style="margin-bottom: 10px;">La presente cesión se realiza {{ $offer->operations->first()?->responsibility }} </li>
