...
@foreach ($offers as $key => $offer)
    ...
    @endphp
    <div class="list_operations list_operations_group">
        ...
        <div class="accept_btn">
            <a onclick="offerAcceptReject(this, 'Approved')" data-offer-id="{{$offer->id}}" class="btn btn-success add_offer_id">{{ __('Accept Contract')}}</a>
        </div>
    </div>
    ...
    <div class="list_operations">
        <div class="cheque_left_top list_operations_top">
            ...
            <div class="case_star">
                <span>{{ __($offer->operations->first()->preferred_payment_method) }}</span>
            </div>
...
<div class="more_document_btn px-3">
    <div class="row">
        <div class="col-md-6 evt_paginate_offers_contract">
            {!! $offers->links() !!}
        </div>
        @if($last_page > 1)
        <div class="col-md-6">
            <div class="sortwrp justify-content-end">
                <input type="text" name="offer_contract_page_no" id="offer_contract_page_no" value="">
                <button class="btn btn-primary evt_offers_contract_got_to_page" data-last-page="{{$last_page}}">Go</button>
            </div>
        </div>
        @endif
    </div>
