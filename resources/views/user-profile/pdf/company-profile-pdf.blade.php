			...
			<table style="width: 100%;">
				<tr>
					<th style="text-align: left;">
						<p style="color: #000000; font-size: 14px; font-weight: 600; text-transform: capitalize;">{{ $issuer->company_name }}<span style="color: #707070; padding:0 0 0 10px; font-size: 12px; font-weight: 500; text-transform: capitalize;"></span></p>
					</th>
				</tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Company name') !!}:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $issuer->company_name ?? '' }}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{{ __('RUC') }}:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $issuer->ruc_code ?? '' }}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('City name') !!}:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $issuer->city?->name ?? '' }}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Date of Registry') !!}:</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ $issuer->registered_at }}</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td style="padding: 0; border: 1px solid #707070;">
						<table style="width: 100%; border-collapse: collapse;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{{ round($average_issuer_rating_days, 2) ?? 0 }}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{!! $average_discount !!} %</td>
							</tr>
							...
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								...
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{!! ($issuer->registry_in_mipo == 'Yes') ? __('Yes') : __('No') !!}</td>
							</tr>
							<tr style="width: 100%; border-bottom: 1px solid #707070;">
								<td style="color: #000000; font-weight: 500; padding: 4px 12px; text-align: left;">{!! __('Verified Address') !!}</td>
								<td style="color: #707070; font-weight: 500; padding: 4px 12px; text-align: right;">{!! ($issuer->verified_address == 'Yes') ? __('Yes') : __('No') !!}</td>
							</tr>
						</table>
					</td>
				</tr>
