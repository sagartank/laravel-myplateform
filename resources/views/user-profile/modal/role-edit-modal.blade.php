...
<div class="modal-content">
    ...
    <form action="{{ route('role.ajax-update',$role->id) }}" method="post" novalidate="novalidate"
        ...
        <div class="modal-body">
            <div class="profile_inputbox">
                ...
                <input type="text" class="text-14-medium" id="name" name="name" value="{{ old('name', $role->display_name) }}" placeholder="Role Name" required>
            </div>
            <div class="profile_inputbox">
                <label for="description" class="text-14-medium">{!! __('Description') !!}</label>
                <textarea placeholder="Define Role" name="description" id="description" required>{{ old('description', $role->description) }}</textarea>
            </div>
