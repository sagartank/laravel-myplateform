<x-app-layout>
    @section('pageTitle', 'Profile User')
    ...
    @php
        $is_favorites = $user->favorites->count() > 0 ? 'active' : '';
    @endphp
        ...
        <div class="container">
            <div class="profile_title">
                <div class="title">
                    ...
                    <h5 class="text-24-semibold">{{ __('Profile') }}</h5>
                </div>
                <div class="btnbox_section">
                    ...
                    <div class="mob_fav_sec evt_is_favorites {{ $is_favorites }}" role="button">
                        <i  role="button">
                            ...
                            {{-- <img src="{{ asset('images/mipo/heart.svg') }}" alt="no-image"> --}}
                        </i>
                        {{-- <img src="{{ asset('images/mipo/localprofile-img1.svg') }}" alt="no-image"> --}}
                    </div>
                    <div class="mob_export_section evt_download_pdf_seller"  data-href="{{ route('profile.public-seller-pdf') }}"
                    data-seller-slug="{{ $user->slug }}">
                        <img src={{ asset('images/mipo/mobileexportbtn.svg') }} alt="no-image">
                    </div>
                    <div class="export_wrap">
                        <a href="javascript:;" class="text-14-medium evt_download_pdf_seller"
                        data-href="{{ route('profile.public-seller-pdf') }}"
                        data-seller-slug="{{ $user->slug }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                            ...
                            <div class="left_part">
                                <div class="name_box">
                                    ...
                                    <div class="rating text-16-medium">
                                        ...
                                        {{ floor($user->ratings_avg_rating_number) }}{!! __('/5') !!} ( {{ floor($user->ratings_count) }})
                                    </div>
                                </div>
                        ...
                        <div class="public_caption public_info">
                            ...
                            <p class="text-16-medium">{!! $user->issuer?->basic_info !!}</p>
                        </div>
                        @php
                                ...
                                <div class="col-lg-4 col-6">
                                    <div class="public_data_block">
                                        <div class="text">
                                            ...
                                            {{-- <p class="text-20-medium">{{ ($draft + $rejected + $pending) }}</p> --}}
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="multi_reviews">
                                        @if ($user->ratings->count() > 0)
                                            @foreach ($user->ratings->take(5) as $key => $user_rating)
                                            ...
                                            @endforeach
                                            @foreach ($user->ratings->skip(5) as $key => $user_rating)
