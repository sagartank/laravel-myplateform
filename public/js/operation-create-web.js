...
$(document).ready(function () {
    ...
    $('#issuance_date').daterangepicker({
        applyLabel: apply_en_msg,
        cancelButtonLabel: cancle_en_msg,
        ...
        submitOperationForm($('#form-create-operation'), (res) => {
    ...
    $('#form_add_payer_issuer').submit(function (e) {
        e.preventDefault();
        $('#cmd_btn_add_payer').val(please_wait_en_msg);
        $("#cmd_btn_add_payer").attr("disabled", true);
        $.ajax({
            type: 'POST',
            url: url_payer_issuer_add,
            dataType: 'json',
        ...
        success: function (res) {
            ...
            if (res.success) {
                ...
                (res.documents).forEach(document => {
                    ...
                    documentDropzone.displayExistingFile(documentFile, document.extension == 'pdf' ? pdf_img : document.document_url, function () {
                ...
                (res.supportingAttachments).forEach(supportingAttachment => {
                    ...
                    supportingAttachmentDropzone.displayExistingFile(supportingAttachmentFile, supportingAttachment.extension == 'pdf' ? pdf_img : supportingAttachment.attachment_url, function () {
...
function updateDocumentDisplayName(el) {
    $.ajax({
        ...
        url: url_update_doc_name_display,
...
function updateSupportingAttachmentDisplayName(el) {
    $.ajax({
        ...
        url: url_update_supp_name_display,
...
$(document).on('click', '#evt_cmd_mob_create_form', function(e){
    e.preventDefault();
